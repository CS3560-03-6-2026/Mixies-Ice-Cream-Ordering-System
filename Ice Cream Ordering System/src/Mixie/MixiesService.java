...
import Mixie.Employee.Employee;
import Mixie.Employee.EmployeeDAO;
import Mixie.Employee.employeeRoles;
import Mixie.Flavor.FlavorDAO;
import Mixie.Flavor.IceCreamFlavor;
import Mixie.Orders.Order;
import Mixie.Orders.OrderDAO;
import Mixie.Orders.OrderItem;
import Mixie.Toppings.Prices;
import Mixie.Toppings.Topping;
import Mixie.Toppings.ToppingDAO;
...
public class MixiesService {
    ...
    public boolean updateOrderTip(int orderID, double tip) {
        return orderDAO.updateOrderTip(orderID, tip);
    }
